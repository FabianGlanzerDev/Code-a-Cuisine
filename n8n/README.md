...
Diese Dateien basieren auf den bereitgestellten Eigentümer-Exporten. Workflow-/Node-IDs, Credential-Verweise, Webhook-Konfiguration und benötigte Funktionen bleiben erhalten. Sprechende Node-Namen und Referenzen sind in `node-name-mapping.json` zugeordnet. Alte Zwischenexporte wurden entfernt.
